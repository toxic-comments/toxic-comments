...
2. Для данной матрицы было выполнено PCA разложение, позволившее выделить скрытые направления наибольшей вариативности,
   ...
   Визуализация семантического пространства слов:  <a href="reports/words_semantic_space.html" target="_blank">тык</a>
3. Каждый комментарий представлен как среднее из эмбеддигов слов в него входящих, визуализации <a href="reports/comments_semantic_space.html" target="_blank">тут</a> 
4. На получившихся эмбеддингах была проведена кластеризация (<a href="reports/comments_semantic_space_with_clusters.html" target="_blank">визуализация</a>). 
   Normalized mutual information между классом токсичности комментария и выделенным кластером для лучшей модели равна 0.13, 
   что не очень много, но все равно может быть использовоно в качестве эстиматора для класса токсичности.
