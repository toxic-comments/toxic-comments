...
2. Для данной матрицы было выполнено PCA разложение, позволившее выделить скрытые направления наибольшей вариативности,
   ...
   Визуализация семантического пространства слов:  <a href="https://toxic-comments.github.io/toxic-comments/nonlinear-models/reports/words_semantic_space.html" target="_blank">тык</a>
3. Каждый комментарий представлен как среднее из эмбеддигов слов в него входящих, визуализации <a href="https://toxic-comments.github.io/toxic-comments/nonlinear-models/reports/comments_semantic_space.html" target="_blank">тут</a> 
4. На получившихся эмбеддингах была проведена кластеризация (<a href="https://toxic-comments.github.io/toxic-comments/nonlinear-models/reports/comments_semantic_space_with_clusters.html" target="_blank">визуализация</a>). 
